...
- Guard: never recommend a single metric to leadership in isolation. Industry practice ([Amplitude North Star Framework](https://amplitude.com/blog/product-north-star-metric), [Mixpanel guardrail metrics](https://mixpanel.com/blog/guardrail-metrics/)) pairs one headline metric with three to five input metrics and two to three guardrail (counter) metrics to prevent gaming. Honest framing example: "sign-ups went up, **but** activation stayed flat."
