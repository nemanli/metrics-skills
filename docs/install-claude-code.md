...
Plugin files land in `~/.claude/plugins/marketplaces/metrics-skills/`. To update, re-run the install command.
...
ln -s /path/to/metrics-skills/skills/metrics-basics   ~/.claude/skills/metrics-basics
ln -s /path/to/metrics-skills/skills/metrics-ux       ~/.claude/skills/metrics-ux
ln -s /path/to/metrics-skills/skills/metrics-diagnose ~/.claude/skills/metrics-diagnose
ln -s /path/to/metrics-skills/skills/metrics-present  ~/.claude/skills/metrics-present
ln -s /path/to/metrics-skills/skills/metrics-help     ~/.claude/skills/metrics-help
```

Replace `/path/to/metrics-skills` with the absolute path where you cloned the repo (e.g. `/Users/yourname/Desktop/metrics-skills`).
...
For Method 1 (plugin), check `~/.claude/plugins/marketplaces/metrics-skills/`.  
...
```
/plugin uninstall metrics-skills@metrics-skills
```
